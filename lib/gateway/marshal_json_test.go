...
import (
	...
	// TODO: test how to marshal between JSON and Thrift (is it possible)
...
// func TestJSONMarshalField(t *testing.T) {
// 	var m runtime.JSON
...
// func TestJSONMarshalFieldKnownErrors(t *testing.T) {
// 	var m runtime.JSON
...
// func TestJSONsnmarshal(t *testing.T) {
// 	var (
// 		m   runtime.JSON
...
// func TestJSONUnmarshalField(t *testing.T) {
// 	var m runtime.JSON
// 	for _, fixt := range builtinFieldFixtures {
...
// func TestJSONUnmarshalFieldKnownErrors(t *testing.T) {
// 	var m runtime.JSON
// 	for _, fixt := range builtinKnownErrors {
// 		dest := reflect.New(reflect.TypeOf(fixt.data))
// 		if err := m.Unmarshal([]byte(fixt.json), dest.Interface()); err == nil {
...
// func TestJSONDecoderFields(t *testing.T) {
// 	var m runtime.JSON
// 	for _, fixt := range builtinFieldFixtures {
