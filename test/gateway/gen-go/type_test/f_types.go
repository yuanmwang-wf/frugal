...
type BaseType struct {
	...
	StringTest *string  `thrift:"stringTest,8" db:"stringTest" json:"stringTest,omitempty"`
}
...
var BaseType_StringTest_DEFAULT string

func (p *BaseType) IsSetStringTest() bool {
	return p.StringTest != nil
}

func (p *BaseType) GetStringTest() string {
	if !p.IsSetStringTest() {
		return BaseType_StringTest_DEFAULT
	}
	return *p.StringTest
}
